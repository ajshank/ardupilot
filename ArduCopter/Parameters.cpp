...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Allow Arming from Transmitter,1:SetAttitudeTarget ignores Yaw if yawrate provided, 2:Ignore pilot yaw,3:SetAttitudeTarget interprets Thrust As Thrust,4:Do not stabilize PositionXY,5:Do not stabilize VelocityXY,6:Waypoint navigation used for position targets
    // @User: Advanced
