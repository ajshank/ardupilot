...
void ModeGuided::angle_control_run()
{
    ...
    if (guided_angle_state.use_yaw_rate) {
        attitude_control->input_euler_angle_roll_pitch_euler_rate_yaw(ToDeg(guided_angle_state.euler_rad.x)*100.0f, ToDeg(guided_angle_state.euler_rad.y)*100.0f, ToDeg(guided_angle_state.ang_vel.z)*100.0f);
    }
